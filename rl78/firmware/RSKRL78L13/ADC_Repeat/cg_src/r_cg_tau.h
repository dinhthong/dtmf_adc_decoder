...
#define TAU0_CHANNEL1_DIVISOR                   (64U)     /* fCLK/2^6 */
/* 16-bit timer data register 02 (TDR02) */
#define _0138_TAU_TDR02_VALUE                   (0x0138U)
/* Clock divisor for TAU0 channel 2 */
#define TAU0_CHANNEL2_DIVISOR                   (8U)      /* fCLK/2^3 */
/* 16-bit timer data register 03 (TDR03) */
#define _09C3_TAU_TDR03_VALUE                   (0x09C3U)
/* Clock divisor for TAU0 channel 3 */
#define TAU0_CHANNEL3_DIVISOR                   (8U)      /* fCLK/2^3 */
