...
;             Device\RL78\Devicefile ..\RSKRL78L13\ADC_Repeat\cg_src\r_cg_syste
;             minit.c -oDebug -_msgoff -nq -i..\RSKRL78L13\ADC_Repeat\cg_src -v
;              -w2 -zps -mm -mi0 -saDebug -li -no -g2
; In-file   : ..\RSKRL78L13\ADC_Repeat\cg_src\r_cg_systeminit.c
; Asm-file  : Debug\r_cg_systeminit.asm
; Para-file : 
...
$DGS	GLV_SYM, _R_PORT_Create,	U,	U,	01H,	02H,	01H,	02H
$DGS	AUX_FUN, 00H,		U,	U,	00H,	01H,	00H
$DGS	GLV_SYM, _R_CGC_Create,	U,	U,	01H,	02H,	01H,	02H
$DGS	AUX_FUN, 00H,		U,	U,	00H,	01H,	00H
$DGS	GLV_SYM, _R_TAU0_Create,	U,	U,	01H,	02H,	01H,	02H
$DGS	AUX_FUN, 00H,		U,	U,	00H,	01H,	00H
$DGS	GLV_SYM, _R_ADC_Create,	U,	U,	01H,	02H,	01H,	02H
$DGS	AUX_FUN, 00H,		U,	U,	00H,	01H,	00H
$DGS	GLV_SYM, _R_INTC_Create,	U,	U,	01H,	02H,	01H,	02H
$DGS	AUX_FUN, 00H,		U,	U,	00H,	01H,	00H

	EXTRN	_R_CGC_Get_ResetSource
	EXTRN	_R_PORT_Create
	EXTRN	_R_CGC_Create
	EXTRN	_R_TAU0_Create
	EXTRN	_R_ADC_Create
	EXTRN	_R_INTC_Create
...
; line    25 : /***************************************************************
;              ********************************************************
; line    26 : * File Name    : r_cg_systeminit.c
; line    27 : * Version      : Applilet4 for RL78/L13 V1.00.00.02 [10 May 2013
;              ]
; line    28 : * Device(s)    : R5F10WMG
; line    29 : * Tool-Chain   : CA78K0R
; line    30 : * Description  : This file implements system initializing functi
;              on.
; line    31 : * Creation Date: 05-Jun-21
; line    32 : ****************************************************************
;              *******************************************************/
...
;              re */
; line    50 : /* End user code. Do not edit comment generated here */
; line    51 : #include "r_cg_userdefine.h"
; line    52 : 
; line    53 : /***************************************************************
;              ********************************************************
; line    54 : Global variables and functions
; line    55 : ****************************************************************
;              *******************************************************/
; line    56 : /* Start user code for global. Do not edit comment generated her
;              e */
; line    57 : /* End user code. Do not edit comment generated here */
; line    58 : 
; line    59 : /***************************************************************
;              ********************************************************
; line    60 : * Function Name: R_Systeminit
; line    61 : * Description  : This function initializes every macro.
; line    62 : * Arguments    : None
; line    63 : * Return Value : None
; line    64 : ****************************************************************
;              *******************************************************/
; line    65 : void R_Systeminit(void)
; line    66 : {
...
$DGL	0,2
	clrb	!PIOR						;[INF] 3, 1
; line    68 :     R_CGC_Get_ResetSource();
$DGL	0,3
	call	!!_R_CGC_Get_ResetSource			;[INF] 4, 3
; line    69 :     R_PORT_Create();
$DGL	0,4
	call	!!_R_PORT_Create				;[INF] 4, 3
; line    70 :     R_CGC_Create();
$DGL	0,5
	call	!!_R_CGC_Create					;[INF] 4, 3
; line    71 :     R_TAU0_Create();
$DGL	0,6
	call	!!_R_TAU0_Create				;[INF] 4, 3
; line    72 :     R_ADC_Create();
$DGL	0,7
	call	!!_R_ADC_Create					;[INF] 4, 3
; line    73 :     R_INTC_Create();
$DGL	0,8
	call	!!_R_INTC_Create				;[INF] 4, 3
; line    74 :     CRC0CTL = 0x00U;
$DGL	0,9
	clrb	!CRC0CTL					;[INF] 3, 1
; line    75 :     IAWCTL = 0x00U;
$DGL	0,10
	clrb	!IAWCTL						;[INF] 3, 1
; line    76 :     PMS = 0x00U;
$DGL	0,11
...
; line    79 : /***************************************************************
;              ********************************************************
; line    80 : * Function Name: hdwinit
; line    81 : * Description  : This function initializes hardware setting.
; line    82 : * Arguments    : None
; line    83 : * Return Value : None
; line    84 : ****************************************************************
;              *******************************************************/
; line    85 : void hdwinit(void)
; line    86 : {
_hdwinit:
$DGL	1,25
	di							;[INF] 3, 4
...
;	C_Repeat\cg_src\r_cg_systeminit.c
;
; $FUNC R_Systeminit(66)
;	void=(void)
;	CODE SIZE= 37 bytes, CLOCK_SIZE= 28 clocks, STACK_SIZE= 4 bytes
;
; $CALL R_CGC_Get_ResetSource(68)
;	void=(void)
;
; $CALL R_PORT_Create(69)
;	void=(void)
;
; $CALL R_CGC_Create(70)
;	void=(void)
;
; $CALL R_TAU0_Create(71)
;	void=(void)
;
; $CALL R_ADC_Create(72)
;	void=(void)
;
; $CALL R_INTC_Create(73)
;	void=(void)
;
; $FUNC hdwinit(86)
;	void=(void)
