...
;             Device\RL78\Devicefile ..\RSKRL78L13\ADC_Repeat\cg_src\r_cg_cgc_u
;             ser.c -oDebug -_msgoff -nq -i..\RSKRL78L13\ADC_Repeat\cg_src -v -
;             w2 -zps -mm -mi0 -saDebug -li -no -g2
; In-file   : ..\RSKRL78L13\ADC_Repeat\cg_src\r_cg_cgc_user.c
; Asm-file  : Debug\r_cg_cgc_user.asm
; Para-file : 
...
$DGS	AUX_BEG, 042H,		02H,	01BH
$DGS	AUT_VAR, _reset_flag,	01H,	0FFFFH,	0CH,	01H,	00H,	00H
$DGS	AUT_VAR, _porsr_flag,	00H,	0FFFFH,	0CH,	01H,	00H,	00H
...
; line    25 : /***************************************************************
;              ********************************************************
; line    26 : * File Name    : r_cg_cgc_user.c
; line    27 : * Version      : Applilet4 for RL78/L13 V1.00.00.02 [10 May 2013
;              ]
; line    28 : * Device(s)    : R5F10WMG
; line    29 : * Tool-Chain   : CA78K0R
...
;              re */
; line    46 : 
; line    47 : /* Some of the code in this file is generated using "Application
;               Leading Tool (Applilet)" */
; line    48 : /* Warnings exist in this module. */
; line    49 : 
...
; line    59 : /***************************************************************
;              ********************************************************
; line    60 : * Function Name: R_CGC_Get_ResetSource
; line    61 : * Description  : This function process of Reset.
; line    62 : * Arguments    : None
; line    63 : * Return Value : None
; line    64 : ****************************************************************
;              *******************************************************/
; line    65 : void R_CGC_Get_ResetSource(void)
; line    66 : {
...
; line    67 :     uint8_t reset_flag = RESF;
$DGL	0,2
	mov	a,RESF						;[INF] 2, 1
	mov	[hl+1],a	; reset_flag 			;[INF] 2, 1
; line    68 :     uint8_t porsr_flag = PORSR;
$DGL	0,3
	mov	a,!PORSR					;[INF] 3, 1
	mov	[hl],a	; porsr_flag 				;[INF] 1, 1
; line    69 :     /* Start user code. Do not edit comment generated here */
; line    70 :     /* End user code. Do not edit comment generated here */
; line    71 : }
$DGL	0,6
...
;	C_Repeat\cg_src\r_cg_cgc_user.c
;
; $FUNC R_CGC_Get_ResetSource(66)
;	void=(void)
;	CODE SIZE= 16 bytes, CLOCK_SIZE= 15 clocks, STACK_SIZE= 4 bytes
